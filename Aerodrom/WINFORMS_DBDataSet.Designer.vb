...
Partial Public Class WINFORMS_DBDataSet
    ...
    Partial Public Class DestinationDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddDestinationRow(ByVal Name As String, ByVal Length As Integer, ByVal Price As Integer) As DestinationRow
            Dim rowDestinationRow As DestinationRow = CType(Me.NewRow,DestinationRow)
            Dim columnValuesArray() As Object = New Object() {Name, Length, Price}
    ...
    Partial Public Class DestinationRow
        ...
        Public Property Length() As Integer
            Get
                Try 
                    Return CType(Me(Me.tableDestination.LengthColumn),Integer)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Length' in table 'Destination' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableDestination.LengthColumn) = value
            End Set
        End Property
        ...
        Public Function IsLengthNull() As Boolean
            Return Me.IsNull(Me.tableDestination.LengthColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetLengthNull()
            Me(Me.tableDestination.LengthColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace WINFORMS_DBDataSetTableAdapters
    ...
    Partial Public Class AirportTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Aerodrom.My.MySettings.Default.WINFORMS_DBConnectionString1
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Name, City, ShortName"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Airport"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"INSERT INTO Airport"& _ 
                "(Name, City, ShortName) VALUES ('Artan Sulejmani', 'Basel', 'BSL')"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "INSERT INTO [dbo].[Airport] ([Name], [City], [ShortName]) VALUES (@Name, @City, @"& _ 
                "ShortName)"
            ...
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@City", Global.System.Data.SqlDbType.VarChar, 50, Global.System.Data.ParameterDirection.Input, 0, 0, "City", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@ShortName", Global.System.Data.SqlDbType.VarChar, 50, Global.System.Data.ParameterDirection.Input, 0, 0, "ShortName", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Public Overloads Overridable Function InsertQuery(ByVal Name As String, ByVal City As String, ByVal ShortName As String) As Integer
            ...
            Else
                command.Parameters(2).Value = CType(ShortName,String)
            End If
    ...
    Partial Public Class DestinationTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Destination] ([Name], [Length], [Price]) VALUES (@Name, @Lengt"& _ 
                "h, @Price)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT Name, Length, Price FROM dbo.Destination"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As WINFORMS_DBDataSet.DestinationDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As WINFORMS_DBDataSet.DestinationDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As WINFORMS_DBDataSet.DestinationDataTable = New WINFORMS_DBDataSet.DestinationDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As WINFORMS_DBDataSet.DestinationDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal Length As Global.System.Nullable(Of Integer), ByVal Price As Global.System.Nullable(Of Integer)) As Integer
            If (Name Is Nothing) Then
            ...
            If (Length.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(1).Value = CType(Length.Value,Integer)
            Else
